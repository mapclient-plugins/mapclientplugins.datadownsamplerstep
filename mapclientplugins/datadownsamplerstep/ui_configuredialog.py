...
class Ui_ConfigureDialog(object):
    ...
    def retranslateUi(self, ConfigureDialog):
        ConfigureDialog.setWindowTitle(QCoreApplication.translate("ConfigureDialog", u"Configure Data Downsampler", None))
        self.configGroupBox.setTitle("")
        self.label0.setText(QCoreApplication.translate("ConfigureDialog", u"identifier:  ", None))
        self.label1.setText(QCoreApplication.translate("ConfigureDialog", u"Target length:  ", None))
    # retranslateUi
