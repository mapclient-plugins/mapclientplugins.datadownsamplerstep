...
from mapclientplugins.datadownsamplerstep.ui_configuredialog import Ui_ConfigureDialog
...
class ConfigureDialog(QtWidgets.QDialog):
    ...
    def getConfig(self):
        ...
        config['Target length'] = self._ui.lineEdit1.text()
        return config
    ...
    def setConfig(self, config):
        ...
        self._ui.lineEdit1.setText(config['Target length'])
